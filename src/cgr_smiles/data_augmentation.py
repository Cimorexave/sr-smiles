...
def augment_atom_traversal_order(
    ...
    """
    Randomizes atom traversal order independently in both reactants and products
    of a reaction SMILES.
...
def augment_reassign_atom_map_nums(rxn_smiles: str) -> str:
    """
    Randomly reassigns atom map numbers in both reactants and products
    of a reaction SMILES.
